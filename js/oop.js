...
myHamburger.addGarnish('cucumbers');
myHamburger.addGarnish('tomatoes');
myHamburger.addCheese('white-habanero');
myHamburger.addSauce('chipotle');
myHamburger.addSauce('creamy bbq');
myHamburger.setMeat('aloo -');
myHamburger.setPattyCount(7);
myHamburger.addExtra('pickles');
myHamburger.addExtra('shredded cheese');
